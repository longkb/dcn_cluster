...
OPTS = [
    cfg.StrOpt('username', default='nfv_user',
        help=_('User name for alarm monitoring')),
    cfg.StrOpt('password', default='1234',
        help=_('password for alarm monitoring')),
    cfg.StrOpt('project_name', default='nfv',
        help=_('project name for alarm monitoring')),
    cfg.StrOpt('url', default='http://controller:35357/v3',
